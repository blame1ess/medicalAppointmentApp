            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{URL::asset('/images/main-logo.png') }}" class="block h-12 w-auto fill-current text-gray-800 dark:text-gray-200"/>
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @elseif(\Illuminate\Support\Facades\Auth::user()->user_type == 'admin')
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('manage_staff')" :active="request()->routeIs('manage_staff')">
                    {{ __('Manage Staff') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('faq')" :active="request()->routeIs('appointments')">
                    {{ __('Patients data') }}
