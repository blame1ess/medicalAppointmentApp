                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div>
                        <div class="mb-5 text-lg">
                            {{ __("Use search field below to find necessary service and make an appointment:") }}
                        </div>
                        <div class="inline-flex flex-row">
                            <form action="{{ route('appointments.search') }}" method="get" accept-charset="utf-8">
                                <input type="text" class="border-black rounded-2xl" name="search_name" style="width: 600px" placeholder="Enter the doctor's name or service">
