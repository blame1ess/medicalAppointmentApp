        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @else
                        <div class="text-lg">
                            <label class="text-blue-600">Name:</label> #<br>
                            <label class="text-blue-600">Phone number:</label>#<br>
                            <label class="text-blue-600">Email:</label>#<br>
                            <label class="text-blue-600">Address:</label>#<br>
                            <label class="text-blue-600">Blood type:</label>#<br>
                        </div>
                        <form
                            method="post"
                            action=""
